namespace Dot.Net.DevFast.Etc
{
    ...
    public static class StdLookUps
    {
        ...
        /// </summary>
        public const int DefaultStringBuilderSize = 256;
        ...
        /// </summary>
        public const int DefaultHeapSize = 16;

        /// <summary>
        /// Default step size for the heap.
        /// </summary>
        public const int DefaultHeapResizeStep = 1;
    }
}