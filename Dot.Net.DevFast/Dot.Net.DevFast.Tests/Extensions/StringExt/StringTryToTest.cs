...
namespace Dot.Net.DevFast.Tests.Extensions.StringExt
{
    ...
    {
        [Test]
        public void TryToEnum_Retruns_False_For_Invalid_Cases()
        {
            Assert.False(PerformTryToEnum("", out DateTime wrongDateTime, false));
            Assert.False(PerformTryToEnum("", out double wrongDouble));
            Assert.False(PerformTryToEnum("", out int wrongInt));
        }

        [Test]
        [TestCase(int.MaxValue)]
        [TestCase(int.MinValue)]
        public void TryToEnum_Returns_True_For_Invalid_Parsable_Strings(int invalidInput)
        {
            Assert.True(PerformTryToEnum(invalidInput.ToString(), out DateTimeKind value));
