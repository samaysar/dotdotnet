...
namespace Dot.Net.DevFast.Extensions
{
    ...
    public static class SyncAsync
    {
        ...
        /// <para>NOTE: When <paramref name="withDelgation"/> is set to true and <paramref name="token"/> is not supplied
        ...
        public static Func<Task<T0>> ToAsync<T0>(this Func<T0> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        /// Thus, to truly stop the action execution one must find a way to observe the same token
        /// inside the action body by other means.</param>
        public static Func<T0, Task> ToAsync<T0>(this Action<T0> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        /// Thus, to truly stop the func execution one must find a way to observe the same token
        /// inside the func body by other means.</param>
        public static Func<T0, Task<T1>> ToAsync<T0, T1>(this Func<T0, T1> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        /// Thus, to truly stop the action execution one must find a way to observe the same token
        /// inside the action body by other means.</param>
        public static Func<T0, T1, Task> ToAsync<T0, T1>(this Action<T0, T1> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        /// Thus, to truly stop the func execution one must find a way to observe the same token
        /// inside the func body by other means.</param>
        public static Func<T0, T1, Task<T2>> ToAsync<T0, T1, T2>(this Func<T0, T1, T2> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, Task<T5>> ToAsync<T0, T1, T2, T3, T4, T5>(
            this Func<T0, T1, T2, T3, T4, T5> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, Task> ToAsync<T0, T1, T2, T3, T4, T5>(
            this Action<T0, T1, T2, T3, T4, T5> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, Task<T6>> ToAsync<T0, T1, T2, T3, T4, T5, T6>(
            this Func<T0, T1, T2, T3, T4, T5, T6> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, Task> ToAsync<T0, T1, T2, T3, T4, T5, T6>(
            this Action<T0, T1, T2, T3, T4, T5, T6> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, Task<T7>> ToAsync<T0, T1, T2, T3, T4, T5, T6, T7>(
            this Func<T0, T1, T2, T3, T4, T5, T6, T7> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, Task> ToAsync<T0, T1, T2, T3, T4, T5, T6, T7>(
            this Action<T0, T1, T2, T3, T4, T5, T6, T7> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, Task<T8>> ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8>(
            this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, Task> ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8>(
            this Action<T0, T1, T2, T3, T4, T5, T6, T7, T8> sync, bool withDelgation = true,
            TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
            CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, Task<T10>>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
                this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
                this Action<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task<T11>>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
                this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, Task>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(
                this Action<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, Task<T12>>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(
                this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(
                this Action<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<T13>>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(
                this Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
        ...
        public static Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task>
            ToAsync<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(
                this Action<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> sync, bool withDelgation = true,
                TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously,
                CancellationToken token = default(CancellationToken))
        {
            if (!withDelgation)
