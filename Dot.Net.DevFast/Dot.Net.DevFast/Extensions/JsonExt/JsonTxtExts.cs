...
namespace Dot.Net.DevFast.Extensions.JsonExt
{
    ...
    public static class JsonTxtExts
    {
        ...
        /// <summary>
        /// Returns the JSON serialized string of <paramref name="obj"/> using default <seealso cref="JsonSerializer"/>
        /// asynchronously.
        ...
        /// <summary>
        /// Writes the JSON serialized string of <paramref name="obj"/> default <seealso cref="JsonSerializer"/>
        ...
        /// <summary>
        /// Writes the JSON serialized string of <paramref name="obj"/> using default <seealso cref="JsonSerializer"/>
        /// to <paramref name="jsonWriter"/> asynchronously.
        /// <para>In case of <typeparamref name="T"/> as Large Collection, use 
        /// <see cref="ToJsonArrayAsync{T}(IEnumerable{T},JsonSerializer,TextWriter,bool)"/> (or its variants), instead.</para>
        /// </summary>
